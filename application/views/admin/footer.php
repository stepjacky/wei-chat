...
<script src="/resources/bootstrap/charisma/js/bootstrap-carousel.js"></script>
<!-- autocomplete library -->
<script src="/resources/bootstrap/charisma/js/bootstrap-typeahead.js"></script>
<!-- tour library -->
<script src="/resources/bootstrap/charisma/js/bootstrap-tour.js"></script>
<!-- library for cookie management -->
<script src="/resources/bootstrap/charisma/js/jquery.cookie.js"></script>
<!-- calander plugin -->
<script src='/resources/bootstrap/charisma/js/fullcalendar.min.js'></script>
<!-- data table plugin -->
<script src='/resources/bootstrap/charisma/js/jquery.dataTables.min.js'></script>

<!-- chart libraries start -->
<script src="/resources/bootstrap/charisma/js/excanvas.js"></script>
<script src="/resources/bootstrap/charisma/js/jquery.flot.min.js"></script>
<script src="/resources/bootstrap/charisma/js/jquery.flot.pie.min.js"></script>
<script src="/resources/bootstrap/charisma/js/jquery.flot.stack.js"></script>
<script src="/resources/bootstrap/charisma/js/jquery.flot.resize.min.js"></script>
<!-- chart libraries end -->

<!-- select or dropdown enhancer -->
<script src="/resources/bootstrap/charisma/js/jquery.chosen.min.js"></script>
<!-- checkbox, radio, and file input styler -->
<script src="/resources/bootstrap/charisma/js/jquery.uniform.min.js"></script>
<!-- plugin for gallery image view -->
<script src="/resources/bootstrap/charisma/js/jquery.colorbox.min.js"></script>
<!-- rich text editor library -->
<script src="/resources/bootstrap/charisma/js/jquery.cleditor.min.js"></script>
<!-- notification plugin -->
<script src="/resources/bootstrap/charisma/js/jquery.noty.js"></script>
<!-- file manager library -->
<script src="/resources/bootstrap/charisma/js/jquery.elfinder.min.js"></script>
<!-- star rating plugin -->
<script src="/resources/bootstrap/charisma/js/jquery.raty.min.js"></script>
