  ...
  * ================================= */
  ...
  , matcher: function (item) {
     // console.log(item)
      if(this.propName=="")
	      ...
	      return ~item[this.propName].toLowerCase().indexOf(this.query.toLowerCase())
	}
  ...
  , sorter: function (items) {
      ...
      while (item = items.shift()) {
	    ...
	    var myPropVal = this.propName==""?item:item[this.propName];
  ...
  , render: function (items) {
      ...
      items = $(items).map(function (i, item) {
	    ...
	    i = $(that.options.item).attr('data-value',that.propName==""?item:item[that.propName])
